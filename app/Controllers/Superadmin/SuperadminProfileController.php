...
class SuperadminProfileController extends BaseController
{
    public $helpers = ['form'];
    ...
    public function index()
    {
        ...
        if($this->request->is('put')) {
            if(! $this->validate('updateProfile')) {
                ...
                return view('pages/superadmin/profile', $data);
            }
            ...
            if($user->hasChanged()) {
                ...
                $userModel->save($user);
                return redirect()->to(base_url('/superadmin/profile'))->with('success_message', 'Berhasil mengubah profile');
            }
        }
