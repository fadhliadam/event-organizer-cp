...
<?= $this->section('page_title'); ?>
    <?= view_cell('\App\Libraries\HeadingPointer::show', ['title_header' => 'Form Edit Profile', 'description' => 'Anda bisa mengubah profile disini.']); ?>
<?= $this->endSection(); ?>
        ...
        <div class="col-12 col-md-10 col-lg-9 col-xl-7">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                    <?= form_open_multipart(base_url('/superadmin/profile'), ['class' => 'form form-vertical']); ?>
                                ...
                                <div class="row">
                                    <div class="col-5 col-xl-4 mb-4">
                                        ...
                                        <label for="image" class="position-relative overflow-hidden w-full h-75 w-75 p-3 py-xl-4 rounded text-center bg-secondary-subtle border d-flex align-items-center justify-content-center" style="cursor:pointer">
                                            ...
                                            <img id="preview-image" src="<?= base_url('/assets'.'/'.session()->get('image')); ?>" class="position-absolute z-1 img-fluid h-100 object-fit-cover">
                                        </label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" name="username" class="form-control <?= $validation->hasError('username') ? 'is-invalid' : ''; ?>" placeholder="Isikan username" id="username" value="<?= set_value('username', session()->get('username')); ?>">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input type="email" name="email" readonly disabled class="form-control <?= $validation->hasError('email') ? 'is-invalid' : ''; ?>" placeholder="Isikan email" id="email" value="<?= set_value('email', session()->get('email')); ?>">
                                                <div class="form-control-icon">
