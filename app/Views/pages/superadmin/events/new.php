        ...
        <div class="col-12 col-md-10 col-lg-9 col-xl-7">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                    <?= form_open_multipart(base_url('/superadmin/events/new'), ['class' => 'form form-vertical']); ?>
                                    ...
                                    <div class="col-12 mt-5">
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" name="name" autofocus class="form-control <?= $validation->hasError('name') ? 'is-invalid' : ''; ?>" placeholder="Isikan nama event" id="name" value="<?= set_value('name', old('name')); ?>">
